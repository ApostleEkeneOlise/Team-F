...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    ...
    $db->query("INSERT INTO lost_items (ref_id, item_name, category, description, location, date_lost)
    ...
    $matchQuery = "
        ...
        WHERE item_name = '$item' 
          AND category = '$cat'
          AND location = '$loc'
          AND date_found BETWEEN '$fromDate' AND '$toDate'
    ";
    ...
    header("Location: lost_submit1.php?success=1");
    exit();
}
?>
...
<body>
  <header>
    ...
    <nav>
      <ul>
        ...
        <li><a href="found_submit.php">Report Found</a></li>
  ...
  <section class="report-form">
    ...
    <form action="lost_submit1.php" method="POST" enctype="multipart/form-data">        
      ...
      <select name="location" required>
        <option value="" disabled selected>Select lost item Location </option>        
        <option value="Entrance">Etrance</option>
